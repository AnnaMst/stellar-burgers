...
import { createOrderThunk, getOrderByNumberThunk, getUserOrdersThunk, setOrders, setOrderModalData, clearOrderModalData } from '../slices/order-slice';
import * as api from '@api';

jest.mock('@api');

describe('orderSlice integration tests', () => {
  const mockOrder = { _id:'1', status:'done', name:'Burger', createdAt:'2025-01-01', updatedAt:'2025-01-01', number:100, ingredients:['1','2'] };
